...
if("TRUE" STREQUAL "TRUE")
  set(j2s6s300_ikfast_SOURCE_PREFIX /home/li/kinova_ws/src/kinova-ros/kinova_moveit/inverse_kinematics_plugins/ikfast/j2s6s300_ikfast)
  set(j2s6s300_ikfast_DEVEL_PREFIX /home/li/kinova_ws/devel)
  ...
  set(j2s6s300_ikfast_INSTALL_PREFIX /home/li/kinova_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'j2s6s300_ikfast' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'shovington <shovington@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'j2s6s300_ikfast' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/li/kinova_ws/src/kinova-ros/kinova_moveit/inverse_kinematics_plugins/ikfast/j2s6s300_ikfast/${idir}'.  Ask the maintainer 'shovington <shovington@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${j2s6s300_ikfast_dep}_FOUND)
      find_package(${j2s6s300_ikfast_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${j2s6s300_ikfast_dep} REQUIRED ${depend_list})
  endif()
